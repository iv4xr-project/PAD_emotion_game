...
def parameterized_agent_play(parameters, map_name, render, perceptor_on = False):
	...
	if perceptor_on:
		...
		return action_list, pos_file_path, perceptor_file
	else:
		action_list, pos_file_path = play_with_agent(agent_type, parameters, date_time, frame_rate, map_name, map_height, map_width, small_fontzy, medium_fontzy, big_fontzy, num_directions, render = render, perceptor_on = perceptor_on)
		return action_list, pos_file_path
...
def play_and_predict_genetic_agent(trained_model_file, agent_parameters, map_name, slice_number, render):

	#lets first test the predictor

	trained_model = predictor.load(trained_model_file)

	action_list, pos_file_path, perceptor_file = parameterized_agent_play(agent_parameters, map_name, render, perceptor_on = True)

	my_data = predictor.new_get_processed_data_no_output(perceptor_file, slice_number)
	...
	predictor.save_dimension_over_location_predicted(pos_file_path, prediction, slice_number, show = True)
